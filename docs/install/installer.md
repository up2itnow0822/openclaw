...
<Steps>
  ...
  <Step title="Ensure Node.js 24 by default">
    Checks Node version and installs Node 24 if needed (Homebrew on macOS, NodeSource setup scripts on Linux apt/dnf/yum). OpenClaw requires Node 24 or later.
  </Step>
...
| `--node-version <ver>`      | Node version (default: `24`)                                                    |
...
<Steps>
  ...
  <Step title="Ensure Node.js 24 by default">
    If missing, attempts install via winget, then Chocolatey, then Scoop. OpenClaw requires Node 24 or later.
  </Step>
  <Step title="Install OpenClaw">
